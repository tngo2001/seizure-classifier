function [data,annotations] = edfread2(filename,varargin)
%edfread Read data from the EDF or EDF+ file. This file has been edited by
%Mekaeel Karim to read in EDF files from the TUH EEG Dataset Properly.
